...
const deepai = require('deepai'); // ലോക്കലിൽ, deepmain.js സൃഷ്‌ടിച്ച് നിങ്ങൾക്ക് ഇഷ്ടാനുസൃതമാക്കാവുന്ന രീതിയിൽ ഇത് ഉപയോഗിക്കാം. വെബ് സെർവറുകളിൽ പ്രവർത്തിക്കുന്നില്ല!!
