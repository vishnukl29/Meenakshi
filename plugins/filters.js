/* Copyright (C) 2021 vishnuserkYamkulam

Licensed under the  GPL-3.0 License;
you may not use this file except in compliance with the License.

Meenakshi WhatsAsena by Vishnuser
*/
const fs = require('fs')
...
const array = ['srinisha','Hi','set','love','set','line','para','srinisha','akka']
array.map( async (a) => {
...
Asena.addCommand({on: 'text', fromMe: false}, (async (message, match) => {
     ...
     if (message.jid === '917356793728-1569511990@g.us') {
        ...
        if(banned !== undefined) return
        if (!!message.mention && message.mention[0] == '916235989299@s.whatsapp.net') {
await message.client.sendMessage(message.jid, fs.readFileSync('./nrithyadevu/mention.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted: message.data, ptt: true})
        }
        if (!!message.mention && message.mention[0] == '919061418346@s.whatsapp.net') {
await message.client.sendMessage(message.jid, fs.readFileSync('./nrithyadevu/kang.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted: message.data, ptt: true})
        }
        if (!!message.mention && message.mention[0] == '919061418346@s.whatsapp.net') {
await message.client.sendMessage(message.jid, fs.readFileSync('./nrithyadevu/kang1.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted: message.data, ptt: true})
        }
        if (!!message.mention && message.mention[0] == '919061418346@s.whatsapp.net') {
...
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
       await message.client.sendMessage(message.jid, fs.readFileSync('./nrithyadevu/' + a + '.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted: message.data, ptt: true})
}
});
    }
...
Asena.addCommand({on: 'text', fromMe: false}, (async (message, match) => {
    ...
    if(banned !== undefined) return
    if (!!message.mention && message.mention[0] == '919061418346@s.whatsapp.net') {
await message.client.sendMessage(message.jid, fs.readFileSync('./sticker/kang.webp'), MessageType.sticker, { mimetype: Mimetype.webp, quoted : message.data, ptt: false})
    }
    if (!!message.mention && message.mention[0] == '919061418346@s.whatsapp.net') {
