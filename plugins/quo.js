...
Asena.addCommand({pattern: 'quote', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
...
Asena.addCommand({pattern: 'quote', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
